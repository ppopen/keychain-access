...
### list
```bash
./skills/keychain-access/keychain-access.sh list --service my-app --account automation-bot
```
...
### get
```bash
./skills/keychain-access/keychain-access.sh get --service my-app --account automation-bot --keychain /tmp/my.keychain --raw
```
...
### set
```bash
printf '<SECRET>' | ./skills/keychain-access/keychain-access.sh set --service my-app --account automation-bot --password-stdin --yes
```
...
### delete
```bash
./skills/keychain-access/keychain-access.sh delete --service my-app --account automation-bot
```
